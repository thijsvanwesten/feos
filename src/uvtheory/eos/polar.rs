...
impl MeanSegmentNumbers {
    pub fn new(parameters: &UVParameters, polarity: Multipole) -> Self {
...
impl<D: DualNum<f64> + Copy> HelmholtzEnergyDual<D> for Dipole {
    fn helmholtz_energy(&self, state: &StateHD<D>) -> D {
        ...
        let eps_ij_t = p.eps_k_ij.mapv(|v| t_inv * v);
...
mod tests {
    use super::*;
    use crate::uvtheory::parameters::utils::{carbon_dioxide_parameters, dme_parameters};
    ...
    fn test_dipolar_contribution() {
        ...
        assert_relative_eq!(a, -0.014098784604842502, epsilon = 1e-6);
    }
    ...
    fn test_quadrupolar_contribution() {
        ...
        assert_relative_eq!(a, -0.04391827128506653, epsilon = 1e-6);
    }
}
